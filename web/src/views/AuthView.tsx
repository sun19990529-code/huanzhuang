                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <select
                        ...
                        className="w-full bg-white border border-[#EAE6DF] focus:border-[#D63031] rounded-2xl px-3 py-2 text-xs text-stone-800 focus:outline-none"
                      >
                    ...
                    <div className="grid grid-cols-3 gap-2 text-[11px]">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-[#FAF8F5] border border-[#EAE6DF] rounded-xl p-1.5 text-center font-bold text-stone-800"
                        />
                      </div>
                      <div>
